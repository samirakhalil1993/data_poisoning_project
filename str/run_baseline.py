#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Baseline experiment - ren träningsdata"""
...
def save_results(attack_type, attack_rate, accuracy, f1, train_size, cm, filename="results/logs/baseline.csv"):
...
# Spara
save_results("baseline", 0.0, test_accuracy, test_f1, len(train), cm)
